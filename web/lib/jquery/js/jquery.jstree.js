	...
	$.jstree.plugin("ui", {
		...
		_fn : {
			...
			hover_node : function (obj) {
				...
				this.data.ui.hovered = obj.children("a").addClass("jstree-hovered ui-state-hover").parent();
				this.__callback({ "obj" : obj });
			},
			dehover_node : function () {
				...
				p = obj.children("a").removeClass("jstree-hovered ui-state-hover").parent();
...
(function ($) {
	...
	$(function () {
		var css_string = '' +
			'#vakata-contextmenu { position:absolute; margin:0; padding:0; min-width:180px; background:#ebebeb; border:1px solid silver; z-index:10000; *width:180px; } ' +
...
(function ($) {
	$.jstree.plugin("html_data", {
		...
		_fn : {
			...
			_is_loaded : function (obj) {
				obj = this._get_node(obj);
				var data = this._get_settings().html_data
				return obj == -1 || !obj || !data.ajax || obj.is(".jstree-open, .jstree-leaf") || obj.children("ul").children("li").size() > 0;
			},
