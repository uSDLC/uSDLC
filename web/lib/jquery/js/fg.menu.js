...
function Menu(caller, options) {
	...
	var caller = $(caller);
	var container = $('<div/>', {class: 'fg-menu-container ui-widget ui-widget-content ui-corner-all'}).append($(options.content))
	this.menuOpen = false;
...
Menu.prototype.flyout = function(container, options) {
	...
	container.addClass('fg-menu-flyout').find('li:has(ul)').each(function() {
		...
		$(this).find('a:eq(0)').addClass('fg-menu-indicator').html('<span class="ui-icon ' + options.nextMenuLink + '"></span>' + $(this).find('a:eq(0)').html()).hover(
			function() {
	...
	topList.find('a').each(function() {
		...
		if ($(this).next().is('ul')) {
			$(this)
				...
				.each(function() {
				$(this).html('<span class="ui-icon ' + options.nextMenuLink + '"></span>' + $(this).html());
			})
