...
CKEDITOR.dialog.add('scaytcheck', function(a) {
	...
	var n = a.lang.scayt,o = [
		{id:'options',label:n.optionsTab,elements:[
		...
		{id:'langs',label:n.languagesTab,elements:[
		...
		{id:'dictionaries',label:n.dictionariesTab,elements:[
		...
		{id:'about',label:n.aboutTab,elements:[
			{type:'html',id:'about',style:'margin: 5px 5px;',html:'<div id="scayt_about"></div>'}
		]}
	],p = {title:n.title,minWidth:360,minHeight:220,onShow:function() {
		var y = this;
		...
		m(l(), '');
	},contents:g},q = CKEDITOR.plugins.scayt.getScayt(a);
	...
	var r = function() {
		...
		if (e[1] == 1) {
			for (var C in z.rtl)J[J.length] = I(C, z.ltr);
