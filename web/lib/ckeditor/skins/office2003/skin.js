...
CKEDITOR.skins.add('office2003', (function() {
	...
	return{preload:a,editor:{css:['editor.css']},dialog:{css:['dialog.css']},templates:{css:['usdlc.css']},margins:[0,14,18,14]};
})());
(function() {
	...
	function a() {
		CKEDITOR.dialog.on('resize', function(b) {
			...
			var h = function() {
				var i = f.parts.dialog.getChild([0,0,0]),j = i.getChild(0),k = i.getChild(2);
				k.setStyle('width', j.$.offsetWidth + 'px');
				k = i.getChild(7);
				k.setStyle('width', j.$.offsetWidth - 28 + 'px');
				k = i.getChild(4);
				k.setStyle('height', e + j.getChild(0).$.offsetHeight + 'px');
				k = i.getChild(5);
				k.setStyle('height', e + j.getChild(0).$.offsetHeight + 'px');
			};
			setTimeout(h, 100);
