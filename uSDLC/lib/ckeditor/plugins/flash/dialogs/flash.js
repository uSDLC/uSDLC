        ...
        return{title:i.lang.flash.title,minWidth:420,minHeight:310,onShow:function() {
            ...
            {id:'info',label:i.lang.common.generalTab,accessKey:'I',elements:[
                ...
                {type:'hbox',widths:['25%','25%','25%','25%','25%'],children:[
                    {type:'text',id:'width',style:'width:95px',label:i.lang.common.width,validate:CKEDITOR.dialog.validate.integer(i.lang.common.invalidWidth),setup:function(n, o, p, q) {
                    ...
                    {type:'text',id:'height',style:'width:95px',label:i.lang.common.height,validate:CKEDITOR.dialog.validate.integer(i.lang.common.invalidHeight),setup:function(n, o, p, q) {
                        g.apply(this, arguments);
                        if (q) {
            ...
            {id:'properties',label:i.lang.flash.propertiesTab,elements:[
                ...
                {type:'hbox',widths:['50%','50%'],children:[
                    {id:'align',type:'select',label:i.lang.common.align,'default':'',style:'width : 100%;',items:[
                        [i.lang.common.notSet,''],
                        [i.lang.common.alignLeft,'left'],
                        [i.lang.flash.alignAbsBottom,'absBottom'],
                        [i.lang.flash.alignAbsMiddle,'absMiddle'],
                        [i.lang.flash.alignBaseline,'baseline'],
                        [i.lang.common.alignBottom,'bottom'],
                        [i.lang.common.alignMiddle,'middle'],
                        [i.lang.common.alignRight,'right'],
                        [i.lang.flash.alignTextTop,'textTop'],
                        [i.lang.common.alignTop,'top']
